...
public class TableModel {
	...
	/** View-js目录名 */
	private String viewJsPackageName;
	/** 类名 */
	...
	public String getViewJsPackageName() {
		return viewJsPackageName;
	}

	public void setViewJsPackageName(String viewJsPackageName) {
		this.viewJsPackageName = viewJsPackageName;
	}
